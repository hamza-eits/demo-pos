...
<body>
    ...
    <div align="center">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2">
                    <div align="center"><strong>Gernal Ledger 
                        {{-- {{ ($journals->isNotEmpty()) ? $journals[0]->chartOfAccount->name :'' }} --}}
                    </strong></div>
                </td>
            </tr>
            <tr>
            ...
            <table width="100%" border="1" cellpadding="3" cellspacing="0" style="border-collapse:collapse;">
                <thead>
                    <tr bgcolor="#CCCCCC">
                        ...
                        <th width='80' style="text-align:center;">Chart Of Account</th>
                        ...
                        <th width='75' style="text-align:right;">PAYMENTS / CR</th>
                ...
                @else
                    <tfoot>
                        <tr>
                            <td colspan="8" style="color: red; text-align:center"><b>No Data Found</b></td>
                        </tr>
                    </tfoot>
                @endif
            </table>
