                                        ...
                                        @foreach ($level_1->children as $level_2)
                                            ...
                                            @if ($level_2->children->isNotEmpty())
                                                @foreach ($level_2->children as $level_3)
                                                    ...
                                                    @if ($level_3->children->isNotEmpty())
                        ...
                        <div class="modal-body custom-modal-body">
                            <form id="chart-of-account-store" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="parent_account_name" id="parent_account_name"
                                        class="form-control" readonly>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="modal-footer-btn">
                                    ...
                                    <button type="submit" id="submit-chart-of-account-store"
                                        class="btn btn-submit btn-primary">Create Chart Of Account</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="modal-body custom-modal-body">
                            <form id="chart-of-account-update" enctype="multipart/form-data">
                                ...
                                <div class="modal-footer-btn">
                                    <button type="button" class="btn btn-cancel me-2 btn-dark"
                                        data-bs-dismiss="modal">Cancel</button>
                                    <button type="submit" id="submit-chart-of-account-update"
                                        class="btn btn-submit btn-primary">Update Chart Of Account</button>
                                </div>
                            </form>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#chart-of-account-update').on('submit', function(e) {
                ...
                let chart_of_account_id = $('#edit_id')
            .val(); // Get the ID of the chart-of-account being edited

                let editFormData = new FormData(this);
                $.ajax({
                    type: "POST",
                    url: "{{ route('chart-of-account.update', ':id') }}".replace(':id',
                        chart_of_account_id), // Using route name
                    dataType: 'json',
                    contentType: false,
                    processData: false,
                    cache: false,
