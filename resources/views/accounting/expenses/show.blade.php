                                    ...
                                    <div class="col-md-4">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end" class="form-control-plaintext">{{ $expense->reference_no }}</td>
                                            </tr>
                                            <tr>
                                                <th class="text-end">Expense Type</th>
                                                <td class="text-end" class="form-control-plaintext">{{ $expense->expense_type }}</td>
                                            </tr>
                                            <tr>
                                                <th class="text-end">Spend By</th>
                                                <td class="text-end" class="form-control-plaintext">{{ $expense->spendBy->name }}</td>
                                            </tr>
                                        </table>
                                    </div>
