...
<body>
    {{-- @foreach ($voucher_master as $key => $value) --}}
        <div align="center">
            ...
            <table width="800" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC" bgcolor="#FFFFFF"
        ...
        {{-- <img src="{{ asset('attachments/vouchers/' . $voucher->attachment) }}" width="300px" height="300px" alt="" srcset=""> --}}
