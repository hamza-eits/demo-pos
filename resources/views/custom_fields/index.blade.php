...
@section('content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h3 class="mb-sm-0 font-size-18">All Custom Fields</h3>
    ...
    <script>
        ...
        function editRecord(id) {
            $.get("{{ route('custom-field.edit', ':id') }}".replace(':id', id), function(response) {
        ...
        function deleteRecord(id) {
            if (confirm("Are you sure you want to delete?")) {
                $.ajax({
                    type: 'DELETE',
                    url: "{{ route('custom-field.destroy', ':id') }}".replace(':id', id),
                    data: {
