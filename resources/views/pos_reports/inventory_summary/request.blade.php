            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">inventory Summary</h4>
                    </div>
                </div>
            </div>
           ...
           <div class="card">
            <div class="card-body">
                <div class="col-md-4">
                    ...
                    <form action="{{ route('pos-reports.inventorySummaryShow') }}" method="POST">
                        <div class="col-md-12">
                            @csrf
                            <div class="mt-3">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="date" name="startDate" id="StartDate" value="{{ old('startDate',date('Y-m-d')) }}" class="form-control" required>
                                    <div id="start"></div>
                                </div>
