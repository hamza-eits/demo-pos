...
@section('title', 'Item Wise Sales Summary')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Item Wise Sales Summary</h4>
                    </div>
                </div>
            </div>
           ...
           <div class="">
            <div class="">
                <div class="col-md-4">
                    ...
                    <form action="{{ route('pos-reports.itemWiseSalesSummaryShow') }}" method="POST">
                        <div class="col-md-12">
                            @csrf
                            <div class="mt-3">
                                <div class="form-group">
                                    <label for="StartDate">Start Date</label>
                                    <input type="date" name="startDate" value="{{ old('startDate',date('Y-m-01')) }}" id="StartDate" class="form-control" required>
                                    <div id="start"></div>
                                </div>
                               ...
                               <div class="form-group mt-2">
                                    ...
                                    <select name="product_variation_id" class="select2 form-control">
