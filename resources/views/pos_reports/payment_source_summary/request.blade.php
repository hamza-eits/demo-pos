...
@section('title', 'Payment Source Summary')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Payment Source Summary</h4>
                    </div>
                </div>
            </div>
           ...
           <div class="">
            <div class="">
                <div class="col-md-4">
                    ...
                    <form action="{{ route('pos-reports.paymentSourceSummaryShow') }}" method="POST">
                        <div class="col-md-12">
                            @csrf
                            <div class="mt-3">
